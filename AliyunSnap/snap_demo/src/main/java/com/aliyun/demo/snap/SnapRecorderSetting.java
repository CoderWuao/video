...
public class SnapRecorderSetting extends Activity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void initView() {
        ...
        //视频编码相关按钮
        mEncorderHardwareBtn = findViewById(com.aliyun.demo.crop.R.id.alivc_crop_encoder_hardware);
        mEncorderOpenh264Btn = findViewById(com.aliyun.demo.crop.R.id.alivc_crop_encoder_openh264);
        mEncorderFfmpegBtn = findViewById(com.aliyun.demo.crop.R.id.alivc_crop_encoder_ffmpeg);
